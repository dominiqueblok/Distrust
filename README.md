...
We included some words that are specific to COVID-19 to the lexicon because the dataset contains messages from the COVID period. These words can be omitted for a more general use of the distrust lexicon.
